...
namespace CreeperX
{
    ...
    public sealed partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            MakeNewProfile(MainTabView, "Default Profile", typeof (ProfilePage), new TingRoomProfile("D:/Magic"));
        }
        ...
        {
            MakeNewProfile(MainTabView, "New Profile", typeof (ProfileCreatorPage), null);
        }
